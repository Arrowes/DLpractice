...
![激活函数比较（原稿 p.12）](./深度学习笔记-wyj.assets/page-012.jpg)
...
![反向传播数值示例（原稿 p.18）](./深度学习笔记-wyj.assets/page-018.jpg)
...
![Inverted dropout（原稿 p.24）](./深度学习笔记-wyj.assets/page-024.jpg)
...
![Adam：Momentum 与 RMSprop 的结合（原稿 p.36）](./深度学习笔记-wyj.assets/page-036.jpg)
...
![Batch Normalization（原稿 p.42）](./深度学习笔记-wyj.assets/page-042.jpg)
...
![卷积层参数与多通道输出（原稿 p.63）](./深度学习笔记-wyj.assets/page-063.jpg)
...
![残差块与跳跃连接（原稿 p.70）](./深度学习笔记-wyj.assets/page-070.jpg)
...
![Inception 瓶颈层（原稿 p.74）](./深度学习笔记-wyj.assets/page-074.jpg)
...
![NMS 与 Anchor Boxes（原稿 p.82）](./深度学习笔记-wyj.assets/page-082.jpg)
...
![Triplet Loss：Anchor、Positive、Negative（原稿 p.86）](./深度学习笔记-wyj.assets/page-086.jpg)
...
![内容损失与风格损失（原稿 p.89）](./深度学习笔记-wyj.assets/page-089.jpg)
